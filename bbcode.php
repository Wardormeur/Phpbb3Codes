		...
		foreach ($bbcode_ids as $bbcode_id)
		{
			switch ($bbcode_id)
			{
				...
				case 99:
					...
					$this->bbcode_cache[$bbcode_id] = array(
                                                'preg' => array(
                                                        '#\[wiki=(.+):$uid\](.*)\[/wiki:$uid\]#'	=> $this->bbcode_tpl('wiki', $bbcode_id),
                                                )
                                        );
				break;
		...
		if (empty($bbcode_hardtpl))
		{
			...
			$bbcode_hardtpl = array(
				...
				'email'		=> '<a href="mailto:$1">$2</a>',
                                'wiki'     => '<a href="http://www.tellementnomade.org/wiki/doku.php?id=$1">Pour modifier</a><pre>$2</pre>'
			);
		}
